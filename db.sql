...
SELECT overflow_send_number, overflow_recipent_number, overflow_data, overflow_amount
FROM BankApp.Overflow 
LEFT JOIN Card ON overflow_send_number = card_nr OR overflow_recipent_number = card_nr 
WHERE client_nr = "123456";
